...
def conv2d_fixed_padding(inputs, filters, kernel_size, strides, data_format):
  ...
  inputs=tf.layers.conv2d(inputs=inputs, filters=filters,
...
def network(sess,inputs, resnet_size, bottleneck, num_classes, num_filters,
    kernel_size,conv_stride, first_pool_size, first_pool_stride,
    block_sizes, block_strides, resnet_version=DEFAULT_VERSION, 
    data_format=None,dtype=DEFAULT_DTYPE,training=True):
    ...
    print("Resnet Version={}".format(resnet_version))
